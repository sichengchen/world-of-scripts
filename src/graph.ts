...
const lineagePositions: Record<string, { x: number; y: number }> = {
  ...
  'paleo-hebrew': { x: 800, y: 740 },
  aramaic: { x: 800, y: 1110 },
  samaritan: { x: 1060, y: 760 },
  hebrew: { x: 1060, y: 900 },
  syriac: { x: 1060, y: 1040 },
  mandaic: { x: 1060, y: 1180 },
  nabataean: { x: 1060, y: 1320 },
  arabic: { x: 1580, y: 1320 },
  sogdian: { x: 1320, y: 1040 },
  'old-uyghur': { x: 1580, y: 1040 },
  mongolian: { x: 1840, y: 1040 },
  manchu: { x: 2100, y: 780 },
  kharoshthi: { x: 1060, y: 1460 },
  'old-south-arabian': { x: 280, y: 980 },
  geez: { x: 540, y: 980 },
  'oracle-bone': { x: 1900, y: 260 },
  'bronze-script': { x: 2160, y: 260 },
  'seal-script': { x: 2420, y: 260 },
  'clerical-script': { x: 2680, y: 260 },
  chinese: { x: 2940, y: 260 },
  manyogana: { x: 3200, y: -90 },
  hiragana: { x: 3460, y: -230 },
  katakana: { x: 3460, y: -90 },
  bopomofo: { x: 3200, y: 120 },
  tangut: { x: 3200, y: 260 },
  'khitan-small-script': { x: 3200, y: 400 },
  'khitan-large-script': { x: 3200, y: 540 },
  yi: { x: 3720, y: -230 },
  nushu: { x: 3460, y: 120 },
  hangul: { x: 3460, y: 400 },
