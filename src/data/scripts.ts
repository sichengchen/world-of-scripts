...
export const scripts: ScriptNode[] = [
  ...
  },
  {
    ...
    name: 'Khitan Large',
    commonName: 'Khitan Large Script',
    type: 'logographic',
    status: 'historical',
    region: ['East Asia'],
    startYear: 920,
    ...
    summary:
      'A largely undeciphered script created for the Khitan language of the Liao dynasty. It is usually described as graphically Chinese-influenced and distinct from the later Khitan Small Script.',
    notes: [
      'Representative signs use BabelStone Khitan Large Glyphs Private Use Area character assignments from a Liu and Wang 2004 reconstruction table; these are scholarly font encodings, not standard Unicode scalar values for Khitan Large.',
      'Khitan Large and Khitan Small are separate Khitan writing systems; this graph does not imply that one descends directly from the other.',
    ],
    sources: [
      { label: 'Wikipedia', url: 'https://en.wikipedia.org/wiki/Khitan_large_script' },
      { label: 'BabelStone', url: 'https://www.babelstone.co.uk/Khitan/_LiuWang2004.html' },
    ],
  },
  {
    id: 'nushu',
  ...
  },
  {
    ...
    endYear: 1368,
    direction: 'ttb',
    unicodeBlock: ['Phags-pa'],
    sampleGlyphs: ['ꡀ', 'ꡁ', 'ꡂ', 'ꡃ'],
    characterRows: characterRows(
      'ꡀ ꡁ ꡂ ꡃ ꡄ ꡅ ꡆ ꡇ ꡈ ꡉ ꡊ ꡋ ꡌ ꡍ ꡎ ꡏ ꡐ ꡑ ꡒ ꡓ ꡔ ꡕ ꡖ ꡗ ꡘ ꡙ ꡚ ꡛ ꡜ ꡝ ꡞ ꡟ ꡠ ꡡ ꡢ ꡣ ꡤ ꡥ ꡦ ꡧ ꡨ ꡩ ꡪ ꡫ ꡬ ꡭ ꡮ ꡯ ꡰ ꡱ',
      'ka|kha|ga|nga|ca|cha|ja|nya|ta|tha|da|na|pa|pha|ba|ma|tsa|tsha|dza|wa|zha|za|small a|ya|ra|la|sha|sa|ha|a|i|u|e|o|qa|xa|fa|gga|ee|subjoined wa|subjoined ya|tta|ttha|dda|nna|alternate ya|voiceless sha|voiced ha|aspirated fa|subjoined ra',
    ),
    summary:
      'An alphabet commissioned under Kublai Khan for the Yuan empire and designed by Drogön Chögyal Phagpa. Its letter forms are adapted from Tibetan, but it was used for several languages including Mongolian and Chinese.',
    notes: ['Phags-pa belongs under the Tibetan-derived branch here, not the Old Uyghur-derived Mongolian script lineage.'],
    sources: [
      { label: 'Wikipedia', url: 'https://en.wikipedia.org/wiki/%CA%BCPhags-pa_script' },
      { label: 'Unicode', url: 'https://www.unicode.org/charts/PDF/UA840.pdf' },
    ],
  },
  {
    id: 'manchu',
...
export const edges: ScriptEdge[] = [
  ...
  { from: 'chinese', to: 'khitan-large-script', relationship: 'influenced_by', confidence: 'medium', note: 'Khitan Large Script is graphically Chinese-influenced, but it is a separate Khitan writing system rather than a descendant stage of Chinese characters.', sources: ['https://en.wikipedia.org/wiki/Khitan_large_script', 'https://www.babelstone.co.uk/Khitan/_LiuWang2004.html'] },
