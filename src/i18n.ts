...
const englishText: AppText = {
  ...
  relationshipExplorer: 'Writing system relationship explorer',
  flowLabel: 'World writing systems lineage map',
...
const traditionalChineseText: AppText = {
  ...
  relationshipExplorer: '文字體系關係探索器',
  flowLabel: '世界文字譜系圖',
